      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-wrap lg:flex-nowrap items-center gap-20">
          ...
          <div className="w-full lg:w-1/2 space-y-8">
            ...
            <p className="about-reveal text-xl text-black/60 leading-relaxed max-w-lg font-sans">
          ...
          <div className="w-full lg:w-1/2 relative">
            ...
            {/* Award Stamp */}
            <div className="absolute -bottom-10 -left-10 w-48 h-48 flex items-center justify-center about-reveal">
              <div ref={stampRef} className="relative w-full h-full flex items-center justify-center">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                   <div className="w-12 h-12 bg-black flex items-center justify-center rounded-xl rotate-45">
                      <div className="w-8 h-8 border-2 border-white/20 rounded-lg -rotate-45" />
                   </div>
                </div>
              </div>
            </div>
