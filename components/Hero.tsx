  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0">
        <h2 className="text-[30vw] font-heading font-black text-black/[0.03] uppercase tracking-tighter whitespace-nowrap">
        ...
        <div className="flex justify-between items-end mb-12 lg:mb-20">
          <div className="flex flex-col items-start w-full">
             <div className="w-full">
                <h1 className="reveal-text text-[7vw] lg:text-[6vw] font-heading font-black text-black leading-none tracking-tighter uppercase whitespace-nowrap">
